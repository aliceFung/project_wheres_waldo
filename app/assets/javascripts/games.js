var games = (function($){
  ...
  var gameOver = function(){
    if(total >= 4){
      clearInterval(timer);
       $('#score').text("CONGRATULATION! You found all characters. Your score is " + score);
      var name = prompt("New High Score! What's your name?");
      $('body').prepend('<h3>High Scorer: '+ name +": "+ score+'</h3>');
    }
  };
